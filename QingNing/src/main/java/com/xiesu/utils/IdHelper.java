...
public final class IdHelper {
    ...
    /**
     * 获取一个新的全局唯一，趋势递增的分布式Long型id
     *
     * @return Long type id or return null
     */
    ...
    /**
     * 获取一个新的全局唯一，趋势递增的分布式String型id
     *
     * @return String type id or return null
     */
    ...
    public enum IdPool {
        ...
        private String nextIdString() {
            Long id = nextId();
            return id == null ? null : String.valueOf(nextId());
        }
    }
}
